...
public class ClassT extends TypeT {
    ...
    */
    ...
    static public final int EVENTUAL_MAIL_PLAYER_LEVEL = 40;
    
    static class MailLater extends ClassT {
        public MailLater(int id, String name, String shortName, String iconName, long allowedRaces, long allowedWeapons, long allowedArmors, long[] baseStats) {
            super(id, name, shortName, iconName, allowedRaces, allowedWeapons, allowedArmors, baseStats);
        }
        @Override
        public boolean canWear(int playerLevel, ArmorT armor) {
            return super.canWear(playerLevel, armor) | (playerLevel >= EVENTUAL_MAIL_PLAYER_LEVEL && armor == ArmorT.MAIL);
        }        
    }    
    ...
    static public final MailLater HUNTER = new MailLater(
    ...
    static public final MailLater SHAMAN = new MailLater(
