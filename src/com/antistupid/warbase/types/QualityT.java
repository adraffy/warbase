...
public class QualityT extends TypeT {
    ...
    static public final QualityT UNCOMMON   = new QualityT(2, "Uncommon", 1.00, 2, 2);
    static public final QualityT RARE       = new QualityT(3, "Rare", 1.00, 1, 3);
    static public final QualityT EPIC       = new QualityT(4, "Epic",  1.00, 0, 4);
