...
public class RatingT extends TypeT {
    ...
    //static public final RatingT RESILIENCE_CRIT_TAKEN = new RatingT(StatT.DODGE);
    //static public final RatingT RESILIENCE_PLAYER_DAMAGE_TAKEN = new RatingT(StatT.DODGE);
    /*
