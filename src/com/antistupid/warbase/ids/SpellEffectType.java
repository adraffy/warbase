...
public class SpellEffectType {
    ...
    static public final int TRIGGER_SPELL = 64;
    ...
    static public class SubType {        
        ...
        static public final int PERIODIC_TRIGGER_SPELL = 23;
        ...
        static public final int MOD_INCREASE_MANA = 35;
        static public final int MOD_INCREASE_SWIM_SPEED = 58;
        static public final int MOD_DAMAGE_DONE_CREATURE = 59;
        static public final int MOD_MELEE_AP = 99;
        static public final int MOD_SPEED_ALWAYS = 129;
        static public final int MOD_RATING = 189;
        static public final int MOD_BONUS_ARMOR = 465;
    }
